...
import aleksandr.fedotkin.sellercryptomoney.presentation.di.errorModule
import aleksandr.fedotkin.sellercryptomoney.presentation.di.viewModelModule
import org.koin.dsl.module

val appModule = module {
    includes(viewModelModule, useCaseModule, mapperModule, networkModule, repositoryModule, errorModule)
}
